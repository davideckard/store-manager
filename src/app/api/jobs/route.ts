...
export async function POST(req: NextRequest) {
  try {
    ...
    const { siteId, mode, storeId, orderboardUrl, force, squarePad, randomizeImage, setCategoryImages, fromAuditJob, filterSkus, email, password } = body
    ...
    const safeParams = { siteId, mode, storeId, orderboardUrl, force, squarePad, randomizeImage, setCategoryImages, fromAuditJob, filterSkus }
